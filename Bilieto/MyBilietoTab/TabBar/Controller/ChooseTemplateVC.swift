...
class ChooseTemplateVC: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func getPublicBillBoard() {
        let page : Int = 0
        BilietoService.shared.serviceCallToGetPublicBilBoard(page) { (PublicBillBoard) in
            self._publicBoard = PublicBillBoard
    ...
    func numberOfSections(in tableView: UITableView) -> Int
    {
        ...
        {
            tableView.backgroundView  = getTableBackgroundViewForNoData(NSLocalizedString("public_bilboards_not_found", comment: ""),size:tableView.bounds.size)
            return 0
        }
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.userNameLbl.text = dict.userUniqueName
